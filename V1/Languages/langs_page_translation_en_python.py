...
################################################################################
## Form generated from reading UI file 'langs_page_translation_en.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Languages", None))
        self.label_langCode.setText("")
        self.pushButton_closeDialog.setText(QCoreApplication.translate("Dialog", u"Okey", None))
    # retranslateUi
