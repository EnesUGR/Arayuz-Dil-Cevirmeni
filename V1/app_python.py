...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_newTranslate.setEnabled(False)
        icon5 = QIcon()
        ...
        self.action_enableAutoTranslate.setEnabled(True)
...
"border: none;")
        ...
        self.horizontalLayout_3.addWidget(self.pushButton_allNext)
...
"")
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/img/languages.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButton_showLanguages.setIcon(icon7)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.pushButton_allNext.setToolTip(QCoreApplication.translate("MainWindow", u"T\u00fcm \u00c7evirileri Otomatik \u00c7eviri \u0130le Onayla", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_allNext.setText(QCoreApplication.translate("MainWindow", u"Otomatik", None))
#if QT_CONFIG(tooltip)
