...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_selectEN.setEnabled(False)
        icon2 = QIcon()
...
"border: none;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_enableAutoTranslate.setText(QCoreApplication.translate("MainWindow", u"Otomatik \u00c7eviri (BETA)", None))
#if QT_CONFIG(shortcut)
        self.action_enableAutoTranslate.setShortcut(QCoreApplication.translate("MainWindow", u"Shift+A", None))
#endif // QT_CONFIG(shortcut)
        self.action_page.setText(QCoreApplication.translate("MainWindow", u"\u00c7eviri Sayfas\u0131na Ge\u00e7", None))
#if QT_CONFIG(shortcut)
        self.action_page.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Up", None))
#endif // QT_CONFIG(shortcut)
        self.actionVersiyon_Kontrol.setText(QCoreApplication.translate("MainWindow", u"Versiyon Kontrol", None))
...
#if QT_CONFIG(tooltip)
        self.toolButton_showLanguages.setToolTip(QCoreApplication.translate("MainWindow", u"Dil Kodlar\u0131n\u0131 G\u00f6ster", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.toolButton_nextPage2.setToolTip(QCoreApplication.translate("MainWindow", u"Di\u011fer Sayfaya Ge\u00e7", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.lineEdit_page2_fromCode.setToolTip(QCoreApplication.translate("MainWindow", u"Metininizin Dil Kodunu Girin.", None))
#endif // QT_CONFIG(tooltip)
        self.lineEdit_page2_fromCode.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Kaynak Dil Kodu", None))
#if QT_CONFIG(tooltip)
        self.lineEdit_page2_toCode.setToolTip(QCoreApplication.translate("MainWindow", u"Hedef Dilin Kodunu Se\u00e7in.", None))
#endif // QT_CONFIG(tooltip)
        self.lineEdit_page2_toCode.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Hedef Dil Kodu", None))
#if QT_CONFIG(tooltip)
        self.toolButton_page2_showLanguages.setToolTip(QCoreApplication.translate("MainWindow", u"Dil Kodlar\u0131n\u0131 G\u00f6ster", None))
#endif // QT_CONFIG(tooltip)
        self.toolButton_page2_showLanguages.setText("")
        self.textEdit_page2_fromText.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Metin", None))
        self.textEdit_page2_toText.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u00c7eviri", None))
#if QT_CONFIG(tooltip)
        self.toolButton_nextPage1.setToolTip(QCoreApplication.translate("MainWindow", u"Di\u011fer Sayfaya Ge\u00e7", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
        self.pushButton_page2_translate.setText(QCoreApplication.translate("MainWindow", u"\u00c7evir", None))
